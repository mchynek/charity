...
<section class="help">
    ...
    <div class="help--slides active" data-id="1">
        ...
        <ul class="help--slides-items">
            <c:forEach var="i" begin="0" end="${institution.size()-1}">

                <c:if test="${i%2 ==0}">
                    <li>
                    <div class="col">
                        <div class="title">${institution[i].name}</div>
                        <div class="subtitle">${institution[i].description}</div>
                    </div>
                </c:if>
                <c:if test="${i%2!=0}">
                    <div class="col">
            ...
            <c:if test="${instruction.size()%2!=0}">
                <div class="col">
                    <div class="title"></div>
